  ...
  const runCode = async () => {
    ...
    try {
      const response = await axios.post(
        "https://code-editor-b2st.onrender.com/js",
        {
          code: input,
        }
      );
    ...
    <>
      ...
      <section>
        <div class="lang-list">
          ...
          <Link to="/javascript">
            <div class={`square ${selectedIcon === "js" ? "selected" : ""} `}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
        ...
        <div class="input">
          <nav>
            ...
            <div class="nav-button">
              ...
              <button class="play" onClick={runCode}>
                <img src={require("./icons8-triangle-laces-32.png")} />
              </button>
